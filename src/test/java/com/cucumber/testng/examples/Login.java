...
public class Login {
	...
	public void user_enters_a_valid_user_name() throws Throwable {
		...
		boolean userField = utilis.Utility.elementIsPresent(Login_Page_PO.Inpt_Username);
		if (userField == true) {
	...
	public void user_enters_a_valid_password() throws Throwable {
		...
		boolean passWordField = utilis.Utility.elementIsPresent(Login_Page_PO.Inpt_Password);
	...
	public void clicks_into_the_login_button() throws Throwable {
		Login_Page_PO.Btn_Login.submit();
	}

	/*
	 * @And("^Clicks into the alert page$") public void
	 * clicks_into_the_alert_page() throws Throwable { // Write code here that
	 * turns the phrase above into concrete actions boolean alertWindow =
	 * Utilities.Utility.isAlertPresent(driver); if (alertWindow == true)
	 * Utility.handleAlert(driver); // throw new PendingException(); }
	 */
