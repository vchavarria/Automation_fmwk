...
@CucumberOptions(features = {
		"src/test/resources/com.cucumber.testng.examples/FB_Login.feature" }, tags = "@Scenarios", format = { "pretty",
				"html:target/site/cucumber-pretty1", "json:target/cucumber4.json" })
